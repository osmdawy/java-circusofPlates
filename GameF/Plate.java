...
public class Plate implements Shape , Serializable {
	Dimension imageSize = new Dimension(50, 52);
	String type = "Plate";
	String imageColor;
	String uRLbLackShape = "blackplate.png";
	String uRLOrangeShape = "orangeplate.png";
	String uRLRedShape = "redplate.png";
	String uRLBlueShape = "blueplate.png";
	String uRLGreenShape = "greenplate.png";
	int posX = 0;
	int posY = 0;
